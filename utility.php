...
*/
function makePDF($project_id, $record, $instrument, $event_id, $repeat_instance,$compact_pdf) {
  $filename = "project" . $project_id .
              ...
              "_" . date("Ymd") . ".pdf";
  $pdf_content = REDCap::getPDF($record, $instrument, $event_id, false, $repeat_instance,$compact_pdf);
